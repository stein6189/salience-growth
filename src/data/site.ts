...
const en = {
  ...
  problem: {
    ...
    points: [
      ...
      { title: 'Invisible to the buyers that matter', body: 'You are not in the room when enterprise buyers put together their shortlist — so the work goes to a name they already trust.' },
    ],
    whyNow: {
      ...
      closing:
        'If you are not already visible as an authority, you are not on the shortlist — and 95% of the time, the shortlist is the whole game. Volume does not reach these buyers anymore. Only relevance does.',
    },
  },
  pillars: {
  ...
  testimonials: {
    ...
    items: [
      ...
      { quote: 'Daniel has the strategy — but almost more importantly, he has the execution. We thought his roadmap was ambitious. We were wrong: most of it came in not as an MVP but as an MLP, and far faster than we had imagined.', role: 'Chief Revenue Officer, consulting company' },
      { quote: 'As part of the engagement, Daniel interviewed around 13 of our people and two clients. From that, he built a training tailored exactly to our situation — and the numbers speak for themselves: +60% upsell since, compared with our annual growth over the four years before.', role: 'Partner, IT management company' },
    ],
  },
  about: {
    eyebrow: 'About',
...
const de: typeof en = {
  ...
  problem: {
    ...
    whyNow: {
      ...
      closing:
        'Wer als Autorität nicht sichtbar ist, steht nicht auf der Shortlist — und in 95% der Fälle ist die Shortlist das ganze Spiel. Masse erreicht diese Käufer nicht mehr. Nur Relevanz.',
    },
  },
  pillars: {
  ...
  testimonials: {
    ...
    items: [
      ...
      { quote: 'Niemand konnte uns bisher so klar und faktenbasiert zeigen, was in unserer Zielgruppe funktioniert und was nicht. So schnell haben wir noch nie gelernt — und uns verbessert.', role: 'Sales Director, Outsourcing-Unternehmen' },
